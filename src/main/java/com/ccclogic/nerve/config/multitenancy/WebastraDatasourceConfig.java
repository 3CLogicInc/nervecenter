package com.ccclogic.nerve.config.multitenancy;
...
@EnableJpaRepositories(
        basePackages = "com.ccclogic.nerve.repositories.webastra",
...
public class WebastraDatasourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean metadataEntityManagerFactory() {
        ...
        em.setPackagesToScan("com.ccclogic.nerve.entities.webastra");

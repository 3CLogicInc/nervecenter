package com.ccclogic.sailor.config.scheduled;

import com.ccclogic.sailor.config.multitenancy.MultiTenantDatasourceProvider;
import com.ccclogic.sailor.config.multitenancy.TenantIdentifierResolver;

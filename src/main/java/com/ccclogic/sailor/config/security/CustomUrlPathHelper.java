...
public class CustomUrlPathHelper extends UrlPathHelper{
	...
	public String getPathWithinServletMapping(HttpServletRequest request) {
        ...
        pathWithinApp = pathWithinApp.replaceAll("\\/callcenters\\/\\d+", "");
		...
		if (path != null) {
			...
			if (pathInfo != null) {
				// Use path info if available. Indicates index offset within a servlet mapping?
				// e.g. with index offset: URI="/", servletPath="/index.html"
				return pathInfo;
			}
			if (!this.urlDecode) {
